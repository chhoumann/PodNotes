...
describe("formatDate", () => {
	...
	describe("stress tests for replacement corruption", () => {
		...
		it("handles worst-case format with all potentially conflicting tokens", () => {
			...
			const testCases = [
				{
					date: new Date("2024-03-01T10:05:03"),
					expected: "Friday, March 1st, 2024 at 10:05:03 am (10:05:03 AM)",
				},
				{
					date: new Date("2024-08-15T14:30:45"),
					expected: "Thursday, August 15th, 2024 at 2:30:45 pm (14:30:45 PM)",
				},
				{
					date: new Date("2024-09-22T00:00:00"),
					expected: "Sunday, September 22nd, 2024 at 12:00:00 am (00:00:00 AM)",
				},
				{
					date: new Date("2024-11-07T23:59:59"),
					expected: "Thursday, November 7th, 2024 at 11:59:59 pm (23:59:59 PM)",
				},
			];
	...
	describe("escape syntax [...]", () => {
		...
		it("handles multiple escape sequences", () => {
			expect(formatDate(testDate, "[Date]: YYYY-MM-DD [Time]: HH:mm:ss")).toBe(
				"Date: 2024-03-01 Time: 10:05:03",
			);
		});
